...
int DimensionReduction::execute(
  ...
  if(this->Method == METHOD::AE) {
    ...
    TCDR tcdr(ae_CUDA, NumberOfComponents, ae_Epochs, ae_LearningRate, ae_Optimizer, ae_Method, ae_Model, ae_Architecture, ae_Activation, ae_BatchSize, ae_BatchNormalization, ae_RegCoefficient, IsInputImages);
